...
import { Map, FileText, Scale, Building2, BookOpen } from 'lucide-react';
...
const sections = [
  {
    ...
    title: 'Main Pages',
    links: [
      // FIX: "AI-powered" removed from description
      { name: 'Home',         href: '/',         desc: 'IPO Tracker & Market Data Platform' },
      ...
      <div className="bg-[#0c1e35] px-5 pt-14 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto relative z-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight mb-3">
            All Pages on <span className="text-[#60A5FA]">Finnotia</span>
          </h1>
      ...
      <div className="max-w-3xl mx-auto px-5 py-12">
                  ...
                  {section.links.map((link) => (
                    <li key={link.href}>
                      <Link href={link.href} className="group block">
                        <span className="text-[13px] font-semibold text-[#2563EB] group-hover:underline">
                          {link.name}
                        </span>
        ...
        <div className="mt-8 text-center">
          <p className="text-[11px] text-gray-400">
            ...
            <a href="/sitemap.xml" className="text-[#2563EB] hover:underline">View XML Sitemap →</a>
          </p>
        </div>
      </div>
    </div>
